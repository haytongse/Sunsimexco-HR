...
const EmpInfoByShowrooms = ({ navigation }) => {
    ...
    const searchEmployee = async () => {
        ...
        if (employees !== null || employees !== "") {
            ...
            setLoading(true);
            await request("getEmployeesByShowrooms.php", "POST", param)
                .then(res => {
                    setLoading(false);
                    if (res) {
                        setGetEmps(res);
    ...
    return (
        <Layout loading={loading}>
            <View style={styles.headerContainer}>
                ...
                <MainText title='ពត៌មានបុគ្គលិកតាមសាខា' type='default' />
            </View>
...
export default EmpInfoByShowrooms